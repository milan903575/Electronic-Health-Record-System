...
<body>
    <div class="header">
        ...
        <p class="subtitle">Review and manage pending doctor applications</p>
    </div>
    
    <div class="container" id="cardsContainer">
    <?php
    $query = "SELECT id, first_name, last_name, email, specialization, created_at, hospital_id_proof 
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $email = isset($row['email']) ? htmlspecialchars($row['email']) : 'Not provided';
            ...
            if (strpos(bin2hex($hospital_id_proof_data), '25504446') === 0) {
                // It's a PDF
                ...
                echo "<img src='data:image/jpeg;base64,{$hospital_id_proof_base64}' alt='ID Image'>";
            }
            ...
            if (strpos(bin2hex($hospital_id_proof_data), '25504446') === 0) {
                ...
                echo "<div class='id-proof'>
                        <a href='{$pdf_src}' target='_blank'><button class='view-pdf-btn'>
            ...
            echo "</div>
                  <div class='card-actions'>
                    <button class='approve-btn' onclick=\"showModal('doctor', {$id}, 'approved')\">
                        <svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M22 11.08V12a10 10 0 1 1-5.93-9.14'></path><polyline points='22 4 12 14.01 9 11.01'></polyline></svg>
                        Approve
                    </button>
                    <button class='reject-btn' onclick=\"showModal('doctor', {$id}, 'rejected')\">
        ...
        echo "<div class='empty-state'>
                ...
                <h3>No Pending Doctor Applications</h3>
                <p>You're all caught up! There are no doctor applications waiting for your review.</p>
              </div>";
    }
    ?>
    </div>
    ...
    function showModal(type, id, status) {
        ...
        if (status === 'approved') {
            modalTitle.innerText = "Approve Doctor Application";
            modalMessage.innerText = "Are you sure you want to approve this doctor application? The doctor will be granted access to the system.";
            ...
            modalTitle.innerText = "Reject Doctor Application";
            modalMessage.innerText = "Are you sure you want to reject this doctor application? This action cannot be undone.";
    ...
    document.getElementById("confirmYes").onclick = function () {
        ...
        .then(msg => {
            showToast(statusType === 'approved' ? 
                      ...
                      "Doctor application rejected successfully!");
